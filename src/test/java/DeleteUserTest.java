...
public class DeleteUserTest {
    ...
    public void deleteUserSuccessTest() {
        ...
        softAssertions.assertThat(JsonSchemaValidator
                        .matchesJsonSchemaInClasspath("deleteUserSchema.json").matches(userBodyResponse))
                .withFailMessage("Не совпадает схема ответа")
                .isTrue();

        softAssertions.assertThat(userApi.getUserByName(username).extract().statusCode())
    ...
    /**
     * Проверка удаления несуществуюещего пользователя
     * Действие:
    ...
    public void deleteUserNotFoundTest() {
        userApi.deleteUserByName("notExistingUser")
                .statusCode(404);
    }
